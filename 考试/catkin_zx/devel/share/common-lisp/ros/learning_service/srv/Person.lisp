...
(cl:defmethod banji-val ((m <Person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_service-srv:banji-val is deprecated.  Use learning_service-srv:banji instead.")
  (banji m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_service-srv:id-val is deprecated.  Use learning_service-srv:id instead.")
  (id m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Person-request>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'banji))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'banji))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Person-request>) istream)
  "Deserializes a message object of type '<Person-request>"
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'banji) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'banji) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person-request>)))
  ...
  "0b5a1fdb305a13a3ffd9a94af9843f15")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person-request)))
  "Returns md5sum for a message object of type 'Person-request"
  "0b5a1fdb305a13a3ffd9a94af9843f15")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person-request>)))
  ...
  (cl:format cl:nil "string name~%string banji~%uint32 id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person-request)))
  "Returns full string definition for message of type 'Person-request"
  (cl:format cl:nil "string name~%string banji~%uint32 id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Person-request>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'banji))
     4
))
