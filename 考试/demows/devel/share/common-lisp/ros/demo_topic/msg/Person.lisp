...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name demo_topic-msg:<Person> is deprecated: use demo_topic-msg:Person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_topic-msg:name-val is deprecated.  Use demo_topic-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_topic-msg:id-val is deprecated.  Use demo_topic-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'banji-val :lambda-list '(m))
(cl:defmethod banji-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_topic-msg:banji-val is deprecated.  Use demo_topic-msg:banji instead.")
  (banji m))
